...
public class EnumUtils {
    public static void main(String[] args) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
        ...
        System.out.println("原始方式获取：" + seaconList);
        System.out.println(Season.class.getDeclaredFields());
        List<String> values = getValues(Season.class, String.class);
        System.out.println("反射工具类获取：" + values);
        System.out.println("==================");
        Season season = valueOf(Season.class, "春");
        System.out.println(season);
//        Constructor<Season> constructor = Season.class.getDeclaredConstructor(String.class, int.class, String.class);
//        constructor.setAccessible(true);
//        Season season = constructor.newInstance("春");
//        System.out.println("通过只获取枚举类：" + season);
    }
